...
import { BarChart2, Calendar, History, User, X, Star, Home } from 'lucide-react';
...
const DoctorSidebar = ({ isOpen, setIsOpen }) => {
  ...
  const handleLinkClick = () => {
    // Only close the sidebar if it's open (for mobile)
    if (isOpen) {
      setIsOpen(false);
    }
  };
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm z-40 lg:hidden transition-opacity duration-200"
        ...
        <nav className="p-6 space-y-3">
          <div className="mb-6">
            ...
            <div className="space-y-2">
              <NavLink to="/doctor/home" className={linkClass} onClick={handleLinkClick}>
              ...
              <NavLink to="slots" className={linkClass} onClick={handleLinkClick}>
