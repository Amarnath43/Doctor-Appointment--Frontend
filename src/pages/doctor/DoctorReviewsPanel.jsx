  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-8">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <img
          src={makePublicUrlFromKey(r.patientId?.profilePicture)}
          alt={`Dr. ${r.patientId?.name || 'Patient'}`}
                  ...
                  {r.doctor_reply?.text && (
                    <div className="mt-3 rounded-lg border bg-gray-50 p-3">
                      <div className="text-xs text-gray-500">
                        Your reply • {dayjs(r.doctor_reply.repliedAt).format('DD MMM YYYY HH:mm A')}
                      </div>
                ...
                {activeReview && (
                  <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
                    ...
                    <div className="flex items-center gap-3">
                      <img
                        src={makePublicUrlFromKey(activeReview.patientId?.profilePicture)}
                      ...
                      <div className="min-w-0">
                        <div className="text-sm font-semibold text-gray-900 truncate">
                          {activeReview.patientId?.name || 'Patient'}
                        </div>
                    ...
                    {/* Review text */}
                    {activeReview.text && (
                      <p className="mt-3 text-gray-800 leading-relaxed">"{activeReview.text}"</p>
                    )}
                  </div>
                )}
